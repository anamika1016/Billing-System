    ...
    begin
      ActiveRecord::Base.transaction do
        items_params.each do |item_data|
          ...
          tax_payable = purchase_price * (tax_pct / 100.0)
          ...
          # Update stock (using update instead of update! to avoid stopping on validation if possible,
          # though model validation might still trigger if stock < 0)
